...
- [ ] <del>在"插件菜单"左边新增一个按钮"统计数据"，来方便查看当前直播间的数据，例如，从用户进入直播间开始到现在的进入人数、共收到弹幕数、当前直播间在线人数、礼物总价值统计等等功能</del><br><b>将在2.7.0版本更新</b>
...
- [ ] 在某些特殊的直播间（有特殊活动的直播间），会无法获取"直播切片"菜单内的任何切片链接，目前我只遇到了这个问题。
